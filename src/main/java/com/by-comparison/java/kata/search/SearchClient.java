package com.javacomp.bmwkata.search;
...
import com.javacomp.bmwkata.analysis.JavaLyzer;
import com.javacomp.bmwkata.analysis.PythonLyzer;
        ...
        try {
            ...
            for (Path file : Files.walk(Paths.get(directoryPath)).collect(Collectors.toSet())) {
                ...
                if (Pattern.matches(".*\\.java", file.toString())) {
                    ...
                    // JC Favor Logging over Console Output
                    // JC Favor Format Over Concatenation
                    System.out.println("File " + file.toString() + " is neither a Java file nor a Python file. It will not be analyzed.");
                }
            }
