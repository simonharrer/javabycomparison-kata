...
public class AnalysisResult {
    ...
    public AnalysisResult(boolean java, String name, int LOC, int commentLOC, int numMethod, int nImports) {
        this.javaFile = java;
        this.name = name;
        this.LOC = LOC;
    ...
    */
    ...
    public String print() {
        return name + "\t" + (this.javaFile ? "Java" : "Python") + "\t" + LOC + "\t" + commentLOC + "\t" + numMethod + "\t" + nImports;
    }
}
